...
namespace ReportGen
{
    ...
    public abstract class FadeForm : Form
    {
        ...
        {
            base.OnLoad(e);
            AnimateWindow(this.Handle, 200, AW_ACTIVATE | (_UseSlideAnimation ? AW_HOR_POSITIVE | AW_SLIDE : AW_BLEND));
        }
        ...
        protected override void OnClosing(System.ComponentModel.CancelEventArgs e)
        {
            ...
            if (e.Cancel == false)
            {
                AnimateWindow(this.Handle, 200, AW_HIDE | (_UseSlideAnimation ? AW_HOR_NEGATIVE | AW_SLIDE : AW_BLEND));
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            // FadeForm
            // 
            this.ClientSize = new System.Drawing.Size(116, 70);
            this.Name = "FadeForm";
